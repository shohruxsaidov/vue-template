...
import FoodWidget from '@/assets/illustrations/dashboards/food/widget.svg'

import * as foodDelivery from '@/data/dashboards/food-delivery'
    ...
    <div class="left">
      <div class="left-header">
        <div class="header-image">
          <img src="@/assets/illustrations/dashboards/food/header.svg" alt="" />
        </div>
                  ...
                  <div class="meta-container">
                    <div class="meta-icon">
                      <img
                        ...
                        alt=""
                        @error.once="
                          (event) => useViaPlaceholderError(event, '                            ')
                        "
                      />
                    </div>
        ...
        <div class="cart-widget side-section" :class="[activeSection === 'cart' && 'is-active']">
          ...
          >
            <template #image>
              <img
                class="light-image"
                src="@/assets/illustrations/dashboards/food/cart-placeholder.svg"
                alt=""
              />
              <img
                class="dark-image"
