...
import { VAvatarProps } from '@/components/base/avatar/VAvatar.vue'

import { tasks } from '@/data/apps/kanban'
            ...
            <div ref="newContainer" data-state="new">
              ...
              <div v-if="newTasks.length === 0" class="kanban-empty">
                <img
                  ...
                  src="@/assets/illustrations/projects/board/new.svg"
                  alt=""
                />
                <img
                  class="empty-state theme-image dark-image"
                  src="@/assets/illustrations/projects/board/new-dark.svg"
                  alt=""
                />
            ...
            <div ref="progressContainer" data-state="progress">
              ...
              <div v-if="progressTasks.length === 0" class="kanban-empty">
                <img
                  ...
                  src="@/assets/illustrations/projects/board/progress.svg"
                  alt=""
                />
                <img
                  class="empty-state theme-image dark-image-block"
                  src="@/assets/illustrations/projects/board/progress-dark.svg"
                  alt=""
                />
          ...
          <div class="expanded-content">
            ...
            <div ref="readyContainer" data-state="ready">
              <div v-if="readyTasks.length === 0" class="kanban-empty">
                ...
                <img
                  class="empty-state theme-image light-image-block"
                  src="@/assets/illustrations/projects/board/ready.svg"
                  alt=""
                />
                <img
                  class="empty-state theme-image dark-image-block"
                  src="@/assets/illustrations/projects/board/ready-dark.svg"
                  alt=""
                />
                <p class="empty-text">
          ...
          <div class="expanded-content">
            ...
            <div ref="reviewContainer" data-state="review">
              <div v-if="reviewTasks.length === 0" class="kanban-empty">
                ...
                <img
                  class="empty-state theme-image light-image-block"
                  src="@/assets/illustrations/projects/board/test.svg"
                  alt=""
                />
                <img
                  class="empty-state theme-image dark-image-block"
                  src="@/assets/illustrations/projects/board/test-dark.svg"
                  alt=""
                />
          ...
          <div class="expanded-content">
            ...
            <div ref="completedContainer" data-state="completed">
              ...
              <div v-if="completedTasks.length === 0" class="kanban-empty">
                <img
                  class="empty-state theme-image light-image-block"
                  src="@/assets/illustrations/projects/board/complete.svg"
                  alt=""
                />
                <img
                  class="empty-state theme-image dark-image-block"
                  src="@/assets/illustrations/projects/board/complete-dark.svg"
                  alt=""
                />
