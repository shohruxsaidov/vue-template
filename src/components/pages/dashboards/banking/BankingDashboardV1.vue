...
import { incomeOptions } from '@/data/dashboards/banking-v1/incomeHistoryChart'
...
import {
  ...
  valueSingle,
  optionsSingle
} from '@/data/dashboards/banking-v1/dashboardData'
</script>
          ...
          <div class="column is-6">
            <div class="dashboard-card">
              ...
              <p class="context-text">
                Select one of your bank accounts to transfer some funds. The transfer cannot exceed
                20% of your balance.
              </p>
            ...
            >
              ...
              <p class="context-text">
                This is your Vuero customer level. Reach out higher levels to unlock achievements,
