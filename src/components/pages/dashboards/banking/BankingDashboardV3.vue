...
import { bitcoinChartOptions } from '@/data/dashboards/banking-v3/bitcoinPriceChart'
import { evolutionRadialOptions } from '@/data/dashboards/banking-v3/evolutionRadialChart'
import { popularityGaugeOptions } from '@/data/dashboards/banking-v3/popularityGaugeChart'
      ...
      <div class="column is-4">
        ...
        <div class="dashboard-card is-side">
          ...
          <div class="currency-description">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vide, quantum, inquam,
              fallare, Torquate. Quid censes in Latino fore? Optime, inquam. Ratio quidem vestra sic
              cogit. Prave, nequiter, turpiter cenabat; Duo Reges: constructio interrete.
            </p>
          </div>
