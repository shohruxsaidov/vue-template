...
import { revenueOptions } from '@/data/dashboards/analytics/revenueChart'
import { gaugeOptions } from '@/data/dashboards/analytics/goalChart'
import { barOptions } from '@/data/dashboards/analytics/profitBarChart'
import { optionsCircle } from '@/data/dashboards/analytics/growthRadialChart'
          ...
          <template #body>
            <div class="widget-content">
              <p>
                ...
                <span>{{ followersList[2].name }}</span> are now following you. Take some time to
