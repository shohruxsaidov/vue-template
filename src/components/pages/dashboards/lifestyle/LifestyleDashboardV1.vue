...
import { reputationChartOptions } from '@/data/dashboards/lifestyle-v1/reputationChart'
import { influenceChartOptions } from '@/data/dashboards/lifestyle-v1/influenceChart'
import {
  creativityRadialOptions,
  engagmentRadialOptions,
  popularityRadialOptions
} from '@/data/dashboards/lifestyle-v1/groupedSocialCharts'

import { valueSingle, optionsSingle } from '@/data/dashboards/lifestyle-v1/dashboardData'
      ...
      <div class="dashboard-header">
        ...
        <div class="header-meta">
          ...
          <div class="meta-description">
            <p>
              Artist, musician, songwriter, influencer, these are the many names people give me. But
              for you Iam simply Clarissa. *Forever with all my friends* // Latest video can be
              found here youtu.be/8Tcee5Cyz
            </p>
          </div>
      ...
      <div v-if="activeTab === 'brands'" id="brands-tab" class="tab-content is-active">
        ...
        <div class="page-placeholder">
          <div class="placeholder-content">
            <img
              class="light-image"
              src="@/assets/illustrations/placeholders/having-coffee.svg"
              alt=""
            />
            <img
              class="dark-image"
              src="@/assets/illustrations/placeholders/having-coffee-dark.svg"
              alt=""
            />
            <h3>No brands to show.</h3>
            <p class="is-larger">
              Too bad. Looks like Clarissa enabled her brand privacy setting. You won't be able to
              see the brands she's working with unless you contact her directly.
            </p>
          </div>
        </div>
      </div>
