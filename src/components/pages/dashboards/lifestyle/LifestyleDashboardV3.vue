...
import { energyChartOptions } from '@/data/dashboards/lifestyle-v3/energyChart'
import { overallChartOptions } from '@/data/dashboards/lifestyle-v3/overallChart'
import { oxygenChartOptions } from '@/data/dashboards/lifestyle-v3/oxygenChart'
import { progressChartOptions } from '@/data/dashboards/lifestyle-v3/progressChart'
import {
  ...
  <div class="lifestyle-dashboard lifestyle-dashboard-v3">
    <div class="illustration-header">
      <div class="header-image">
        <img src="@/assets/illustrations/dashboards/lifestyle/doctor.svg" alt="" />
      </div>
          ...
          <template #body>
            <div class="widget-content">
              <p>
                ...
                <span>{{ followersList[2].name }}</span> are now friends with you. Take some time to
