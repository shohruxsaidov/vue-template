...
import { customersOptions } from '@/data/dashboards/personal-v1/customersChart'
import { teamGaugeOptions } from '@/data/dashboards/personal-v1/teamGaugeChart'
import { profitChartOptions } from '@/data/dashboards/personal-v1/profitChart'
</script>
