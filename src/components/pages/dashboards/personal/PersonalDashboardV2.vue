...
import { completionOptions } from '@/data/dashboards/personal-v2/taskCompletionChart'
import { barOptions } from '@/data/dashboards/personal-v2/teamEfficiencyChart'
import { popovers } from '@/data/users/userPopovers'
import * as usersData from '@/data/dashboards/personal-v2/users'
        ...
        <div class="dashboard-card">
          ...
          >
            <template #image>
              <img
                class="light-image"
                src="@/assets/illustrations/placeholders/chart-guy.svg"
                alt=""
              />
              <img
                class="dark-image"
                src="@/assets/illustrations/placeholders/chart-guy-dark.svg"
                alt=""
              />
            </template>
