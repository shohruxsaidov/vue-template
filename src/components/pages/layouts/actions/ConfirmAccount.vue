      ...
      <div class="action-box">
        <VLoader :active="isLoading">
          <div class="box-content">
            <img class="light-image" src="@/assets/illustrations/placeholders/launch.svg" alt="" />
            <img
              class="dark-image"
              src="@/assets/illustrations/placeholders/launch-dark.svg"
              alt=""
            />
            <h3 class="dark-inverted">Please confirm your account</h3>
            <p>
              Hey Erik, It would be really cool if you could give us a hand on this project. There
              are a lot of tasks popping out every day and I feel the team is getting a bit
