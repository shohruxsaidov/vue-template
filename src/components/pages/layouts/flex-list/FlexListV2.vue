...
import * as listData from '@/data/layouts/flex-list-v2'
        ...
        >
          <template #image>
            <img
              ...
              src="@/assets/illustrations/placeholders/projects.svg"
              alt=""
            />
            <img
              class="dark-image is-larger"
              src="@/assets/illustrations/placeholders/projects-dark.svg"
              alt=""
            />
          </template>
        </VPlaceholderPage>
