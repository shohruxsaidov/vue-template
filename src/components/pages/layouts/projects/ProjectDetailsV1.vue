          ...
          <div class="column is-8">
            <div class="project-details-card">
              <div class="card-head">
                ...
                <VIconButton size="small" icon="feather:edit-3" @click="activePanel = 'task'" />
              </div>
            ...
            <div class="side-card">
              ...
              <VBlock center title="VFlights" subtitle="Transportation company">
                <template #icon>
                  <VAvatar
                    size="small"
                    picture="@/assets/illustrations/dashboards/flights/company1.svg"
                  />
                </template>
              </VBlock>
            </div>
          ...
          <div class="project-team-card">
            <div class="columns is-multiline">
              ...
              <div class="column is-6 has-border-bottom">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Si enim ad populum me
                  vocas, eum. Quod cum dixissent, ille contra. Cur id non ita fit? Duo Reges:
            ...
            <div class="columns is-multiline">
              ...
              <div class="column is-4">
                <div class="task-card right-panel-trigger">
                  ...
                  <div class="content-wrap">
                    <div class="left">
                      <VAvatarStack size="small" :avatars="[{ picture: '/demo/avatars/12.jpg' }]" />
                      <div class="attachments">
                        <i aria-hidden="true" class="lnil lnil-paperclip"></i>
              ...
              <div class="column is-4">
                <div class="task-card right-panel-trigger">
                  ...
                  <div class="content-wrap">
                    <div class="left">
                      <VAvatarStack size="small" :avatars="[{ picture: '/demo/avatars/25.jpg' }]" />
                      <div class="attachments">
                        <i aria-hidden="true" class="lnil lnil-paperclip"></i>
