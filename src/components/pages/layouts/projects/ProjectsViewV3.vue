...
<template>
  <div class="all-projects">
    <div class="illustration-header">
      <img class="light-image" src="@/assets/illustrations/projects/header.svg" alt="" />
      <img class="dark-image" src="@/assets/illustrations/projects/header-dark.svg" alt="" />
        ...
        <div class="column is-4">
          <a class="grid-item">
            ...
            <div class="item-description">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Idem iste, inquam, de
                voluptate quid sentit? Itaque contra est, ac dicitis; Quae cum essent dicta,
                discessimus. Iam enim adesse poterit. Duo Reges: constructio interrete.
              </p>
        ...
        <div class="column is-4">
          <a class="grid-item">
            ...
            <div class="item-description">
              ...
              <div class="item-people">
                <VAvatarStack size="small" :avatars="[{ picture: '/demo/avatars/14.jpg' }]" />
