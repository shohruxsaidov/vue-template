    ...
    <div class="search-results-body">
      ...
      <div class="page-placeholder">
        <div class="placeholder-content">
          <img class="light-image" src="@/assets/illustrations/placeholders/search-7.svg" alt="" />
          <img
            class="dark-image"
            src="@/assets/illustrations/placeholders/search-7-dark.svg"
            alt=""
          />
          <h3>We couldn't find any matching results.</h3>
          <p class="is-larger">
            Too bad. Looks like we couldn't find any matching results for the search terms you've
            entered. Please try different search terms or criteria.
          </p>
        </div>
      </div>
    </div>
