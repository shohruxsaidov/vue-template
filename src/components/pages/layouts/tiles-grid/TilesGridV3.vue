...
import { posts } from '@/data/layouts/tile-grid-v3'
    ...
    <div class="tile-grid tile-grid-v3">
      ...
      >
        <template #image>
          ...
          <img
            class="dark-image"
            src="@/assets/illustrations/placeholders/search-6-dark.svg"
            alt=""
          />
        </template>
      </VPlaceholderPage>
              ...
              <div class="meta">
                <div class="tile-title">
                  ...
                  <p class="h-hidden-tablet-l h-hidden-desktop">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Optime, inquam. Duo
                    Reges constructio.
                  </p>
                </div>
                <div class="tile-meta">
