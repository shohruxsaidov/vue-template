...
import { users } from '@/data/layouts/user-grid-v3'
...
<template>
  <div>
    ...
    <div class="user-grid user-grid-v3">
      ...
      >
        <template #image>
          <img class="light-image" src="@/assets/illustrations/placeholders/search-5.svg" alt="" />
          <img
            class="dark-image"
            src="@/assets/illustrations/placeholders/search-5-dark.svg"
            alt=""
          />
        </template>
      </VPlaceholderPage>
        ...
        >
          <template #image>
            <img
              ...
              src="@/assets/illustrations/placeholders/team.svg"
              alt=""
            />
            <img
              class="dark-image is-larger"
              src="@/assets/illustrations/placeholders/team-dark.svg"
              alt=""
            />
          </template>
        </VPlaceholderPage>
