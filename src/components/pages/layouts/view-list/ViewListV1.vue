...
import type { VTagColor } from '@/components/base/tags/VTag.vue'
import type { VAvatarProps } from '@/components/base/avatar/VAvatar.vue'
import * as listData from '@/data/layouts/view-list-v1'
      ...
      <div class="list-view list-view-v1">
        ...
        >
          <template #image>
            <img
              class="light-image"
              src="@/assets/illustrations/placeholders/search-1.svg"
              alt=""
            />
            <img
              class="dark-image"
              src="@/assets/illustrations/placeholders/search-1-dark.svg"
              alt=""
            />
          </template>
        </VPlaceholderPage>
