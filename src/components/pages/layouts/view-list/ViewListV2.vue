...
import { retails } from '@/data/layouts/view-list-v2'
...
<template>
  ...
  <div class="page-content-inner">
    ...
    <div class="list-view list-view-v2">
      ...
      >
        <template #image>
          <img class="light-image" src="@/assets/illustrations/placeholders/search-2.svg" alt="" />
          <img
            class="dark-image"
            src="@/assets/illustrations/placeholders/search-2-dark.svg"
            alt=""
          />
        </template>
      </VPlaceholderPage>
