...
import { offers } from '@/data/layouts/view-list-v3'
      ...
      <div class="list-view list-view-v3">
        ...
        >
          <template #image>
            <img
              class="light-image"
              src="@/assets/illustrations/placeholders/search-3.svg"
              alt=""
            />
            <img
              class="dark-image"
              src="@/assets/illustrations/placeholders/search-3-dark.svg"
              alt=""
            />
          </template>
        </VPlaceholderPage>
          ...
          <div class="list-view-inner">
            ...
            >
              <template #image>
                <img
                  class="light-image"
                  src="@/assets/illustrations/placeholders/thinking-canvas.svg"
                  alt=""
                />
                <img
                  class="dark-image"
                  src="@/assets/illustrations/placeholders/thinking-canvas-dark.svg"
                  alt=""
                />
              </template>
            </VPlaceholderPage>
