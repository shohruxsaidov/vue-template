...
import * as listData from '@/data/layouts/view-list-v4'
        ...
        <div class="list-view-inner">
          ...
          >
            <template #image>
              <img
                class="light-image"
                src="@/assets/illustrations/placeholders/cooking.svg"
                alt=""
              />
              <img
                class="dark-image"
                src="@/assets/illustrations/placeholders/cooking-dark.svg"
                alt=""
              />
            </template>
          </VPlaceholderPage>
