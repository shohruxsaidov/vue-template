...
import { avatarList, avatarListCreative } from '@/data/widgets/ui/avatarList'
import { socialButtonList1, socialButtonList2 } from '@/data/widgets/ui/socialButtonList'
import { followersStats } from '@/data/widgets/ui/followers'
import { products } from '@/data/widgets/ui/productList'

import Widget1 from '@/assets/illustrations/widgets/1.svg'
import Widget2 from '@/assets/illustrations/widgets/2.svg'
import Widget3 from '@/assets/illustrations/widgets/3.svg'
import Widget4 from '@/assets/illustrations/widgets/4.svg'
import Widget5 from '@/assets/illustrations/widgets/5.svg'
import Widget6 from '@/assets/illustrations/widgets/6.svg'
import Widget7 from '@/assets/illustrations/widgets/7.svg'
import Widget8 from '@/assets/illustrations/widgets/8.svg'
</script>
...
<template>
  <div class="columns is-multiline widget-demo-columns">
      ...
      <UIWidget class="text-widget">
        ...
        <template #body>
          <div class="widget-content">
            <p>
              Vuero will be released very soon, probably around the end of the year of the Christmas
              holidays.
            </p>
            <p class="hashtags">
              <a>#uikit</a>
    ...
    <div class="column is-3">
      ...
      <!--Widget-->
      <CallWidget
        picture="@/assets/illustrations/widgets/6.svg"
