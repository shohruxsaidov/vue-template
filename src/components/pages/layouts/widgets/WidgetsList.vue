...
import { todoList1, todoList2, todoList3, todoList4 } from '@/data/widgets/list/todoList'
import { fileList1, fileList2 } from '@/data/widgets/list/fileList'
import { userList } from '@/data/widgets/list/userList'
import { topicList } from '@/data/widgets/list/topicList'
import { timeline } from '@/data/widgets/list/timeline'
</script>
