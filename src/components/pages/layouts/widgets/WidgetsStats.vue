...
import { spark1, spark2, spark3, spark4 } from '@/data/widgets/charts/salesSparksChart'
import { revenueOptions } from '@/data/widgets/charts/revenueAreaChart'
import { lineStatsChartOptions } from '@/data/widgets/charts/lineStatsWidgetChart'
import { flexRadialChartCircleOptions } from '@/data/widgets/charts/flexRadialChartCircleChart'
import { flexRadialChartStripesOptions } from '@/data/widgets/charts/flexRadialChartStripesChart'
import {
  widgetRadialGroup1Options,
  widgetRadialGroup2Options,
  widgetRadialGroup3Options
} from '@/data/widgets/charts/groupedCircleCharts'
import {
  widgetGaugeGroup1Options,
  widgetGaugeGroup2Options,
  widgetGaugeGroup3Options
} from '@/data/widgets/charts/groupedRadialCharts'
import { memberList } from '@/data/widgets/table/memberList'
</script>
