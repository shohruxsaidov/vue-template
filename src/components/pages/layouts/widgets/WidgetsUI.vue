...
import { followersList } from '@/data/widgets/ui/followers'
import { tagList1, tagList2 } from '@/data/widgets/ui/tagList'
import { tabs } from '@/data/widgets/ui/tabList'
import { days } from '@/data/widgets/ui/dayList'
import { iconList } from '@/data/widgets/ui/menuList'
import { notifications } from '@/data/widgets/ui/notificationList'
import { trendWidgetChartOptions } from '@/data/widgets/charts/trendWidgetChart'
        ...
        <template #body>
          <div class="widget-content">
            <p>
              ...
              <span>{{ followersList[2].name }}</span> are now following you. Take some time to look
              at their profile.
            </p>
          </div>
        </template>
        ...
        <template #body>
          <div class="widget-content">
            <p>
              ...
              <span>10 unread messages</span> in your inbox. It could be a good time to check them
              out.
            </p>
          </div>
        </template>
