...
import sidebar from '@/data/landing/sidebar.json'
import auth from '@/data/landing/auth.json'
import minimal from '@/data/landing/minimal.json'
import templates from '@/data/landing/templates.json'
import navbar from '@/data/landing/navbar.json'
