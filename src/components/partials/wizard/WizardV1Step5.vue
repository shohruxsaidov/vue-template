...
import type { WizardTeammate, WizardTeammateRole } from '@/models/wizard'
import { users } from '@/data/wizard'
    ...
    <div v-if="!isAddingMembers" class="page-placeholder is-people">
      <div class="placeholder-content">
        <img
          ...
          src="@/assets/illustrations/wizard/team-placeholder.svg"
          alt=""
        />
        <img
        ...
        <h3>Invite People</h3>
        <p class="is-larger">
          You can already start adding files to your project if you have them handy. But don't
          worry, you'll be able to add and manage files later.
        </p>
