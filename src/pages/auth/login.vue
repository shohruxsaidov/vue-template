...
import VMessage from '@/components/base/message/VMessage.vue'
import VIconWrap from '@/components/base/icon/VIconWrap.vue'
            ...
            <div class="container">
              <div class="columns">
                <div class="column">
                  <img
                    class="hero-image"
                    src="@/assets/illustrations/login/station.svg?url"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div class="hero-body">
            ...
            >
              <p class="recover-text">
                Enter your email and click on the confirm button to reset your password. We'll send
                you an email detailing the steps to complete the procedure.
              </p>
              <div class="control has-validation">
