  ...
  <div>
    ...
    <div id="vuero-signup" class="signup-wrapper">
      ...
      <img
        ...
        class="card-bg"
        src="@/assets/backgrounds/signup/vuero-signup.png?format=webp"
        alt=""
      />
                ...
                <div class="signup-card">
                  <form class="signup-form is-mobile-spaced" @submit.prevent>
                    ...
                    <div class="button-wrap has-help">
                      <VButton color="primary" size="big" bold fullwidth rounded @click="step++">
                        Continue
                      </VButton>
                      <span>
                        Or
            ...
            <div class="columns signup-columns" :class="[step !== 2 && 'is-hidden']">
              <div class="column is-4 is-offset-4 username-form">
                ...
                <form class="signup-form" @submit.prevent="handleSignup">
                  ...
                  <div class="button-wrap is-centered has-text-centered">
                    <VButton size="big" color="primary" rounded primary lower :loading="isLoading">
                      Done
                    </VButton>
                  </div>
                </form>
    ...
    >
      ...
      <template #action>
        <VField grouped>
          ...
          <VControl>
            <VButton class="upload-result" size="big" outlined disabled> Confirm </VButton>
          </VControl>
        </VField>
      </template>
    </VModal>
